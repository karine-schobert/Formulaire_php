            ...
            <div class="Container_Formulaire">
                <section class="formulaire-inscription">
                    ...
                    <form action="" method="POST" >
                        ...
                        <fieldset>
                            ...
                            <div>
                                <input type="radio" id="Anglais" name="Option" value="Anglais">
                            ...
                            <div>
                                <input type="radio" id="Espagnole" name="Option" value="Espagnole">
                                <label for="Espagnole">Espagnole</label>
                            </div>
                            <div>
                                <input type="radio" id="Italien" name="Option" value="Italien">
                                <label for="Italien">Italien</label>
                            </div>
                        </fieldset>
 
                        <fieldset>
                            <legend>Options langues: <input type="radio" id="LV2" name="LV2"  required value="LV2">
                ...
                ?>
                    ...
                    <?php
                        ...
                        //  die(); 
                    ?>
                    <h4>Tu es au college  ou au lycee Choisit ta LV1 :</h4>
                         <?php
                            if(isset($_POST)&& ($_POST)){
                                if ($age >=10 && $age <= 15 )
                     ...
                     <h4>tu es au lycee Choisit  ta LV2</h4>
